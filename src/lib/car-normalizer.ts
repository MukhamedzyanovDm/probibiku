...
Если ты не знаешь такой автомобиль или это абстрактное/выдуманное имя (например, "Ласточка", "Моя малышка", "Пробибику"), верни исходные значения пользователя без изменений (например, для марки "Ласточка" и модели "супер" верни {"make": "Ласточка", "model": "супер"}).
