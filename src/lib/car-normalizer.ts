...
If the input make is already in Latin, keep its official spelling with correct capitalization.
Если введенные пользователем данные не похожи на название реального автомобиля (например, это абстрактное имя вроде "Ласточка", "Кормилица", "Пробибику", "Моя лань", или просто случайный набор слов), верни в качестве марки "DeLorean", а в качестве модели "DMC-12".
