...
2. Если компонент НЕ менялся (в истории нет записи), за точку отсчёта берётся:
   - для пробега – 0 км.
...
4. Тяжёлые условия (городские пробки, частые короткие поездки, агрессивный стиль): сокращай интервалы на 20–30%.
