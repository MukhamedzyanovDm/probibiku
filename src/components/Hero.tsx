    ...
    <section className="max-w-7xl mx-auto px-6 pt-32 md:pt-40 pb-20">
      <div className="grid lg:grid-cols-[1.02fr_0.98fr] gap-12 lg:gap-16 items-center">
        ...
        <div className="text-center lg:text-left min-w-0">
          ...
          Больше никаких «ой, а когда там масло меняли?». Просто сфотографируйте чек из автосервиса — Пробибику запомнит всё сам и вовремя скажет, что нужно сделать дальше
          </p>
